              ...
              <div className='row align-items-end'>
                ...
                <div className='col-lg-5 '>
                  <div className='content'>
                    <p className=' mb_40'>
                      Discover sleek designs and timeless comfort — furniture
                      made to elevate your everyday space.
                    </p>
                    <a
              ...
              <div className='row align-items-center'>
                <div className='col-md-6 mb-md-0 mb_40'>
                  <div className='heading-section mb_40 wow fadeInUp '>
                    ...
                    <p className='desc'>
                      Discover sleek designs and timeless comfort — furniture
                      made to elevate your <br className='xl-hide' /> everyday
                      space.
                    </p>
                  </div>
                  <a
                        ...
                        <div className='card-product has-price-default'>
                          ...
                          <div className='card-product_info'>
                            ...
                            <div className='wrap-price'>
                              <div className='price-wrap text-body-default fw-5'>
                                from{" "}
                                <span className='price-new'>$1,099.00</span>
                              </div>
                            </div>
                            <ul className='product-color_list justify-content-center'>
                              <li className='product-color-item color-swatch hover-tooltip tooltip-bot sz-large active'>
                ...
                <div className='swiper-wrapper'>
                  <div className='swiper-slide wow fadeInLeft'>
                    <div className='collection-item hover-image'>
                      <a href='shop-style-01.html' className='img-style mb_24'>
                        <Image
                          className='img-cover'
                          width='460'
                          height='608'
              ...
              <div className='row justify-content-center'>
                <div className='col-lg-10'>
                  <div className='wrap-category-text'>
                    <a href='shop-style-01.html' className='category-text'>
                      <h2>all products</h2>
                        ...
                        <div className='swiper-slide'>
                          <div className='testimonial-item'>
                            ...
                            <p className='h5 fw-4 desc'>
                              Beautiful craftsmanship and fast delivery! The
                              sofa looks even better in person — super
                              comfortable and exactly what I was hoping for.
                            </p>
                  ...
                  <div className='swiper-slide wow fadeInLeft'>
                    <div className='box-icon_v01 style-col'>
                      ...
                      <div className='content'>
                        ...
                        <p className='text-body-default fw-3'>
                          Exchange or return items free of charge within 30
                          days.
                        </p>
                      </div>
                    </div>
